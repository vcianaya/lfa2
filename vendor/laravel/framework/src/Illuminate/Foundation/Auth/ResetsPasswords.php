...
trait ResetsPasswords
{
    ...
    {
        $this->validate($request, ['NICK' => 'required']);
    }
    ...
    {
        return redirect()->back()->withErrors(['NICK' => trans($response)]);
    }
    ...
    public function showResetForm(Request $request, $token = null)
    {
        ...
        if (property_exists($this, 'resetView')) {
            return view($this->resetView)->with(compact('token', 'NICK'));
        }

        if (view()->exists('auth.passwords.reset')) {
            return view('auth.passwords.reset')->with(compact('token', 'NICK'));
        }

        return view('auth.reset')->with(compact('token', 'NICK'));
    }
    ...
    {
        return $request->only(
            'NICK', 'password', 'password_confirmation', 'token'
        );
    }
    ...
    protected function getResetFailureResponse(Request $request, $response)
    {
        return redirect()->back()
            ...
            ->withErrors(['NICK' => trans($response)]);
    }
